(function() {
    ...
    var AudioContext = typeof window !== 'undefined' ?
        ...
        (typeof global !== 'undefined' ? global.AudioContext || global.webkitAudioContext : null);
    ...
    Pizzicato.Sound = function(description, callback) {
        ...
        this.attack = hasOptions && util.isNumber(description.options.attack) ? description.options
            .attack : defaultAttack;
        this.volume = hasOptions && util.isNumber(description.options.volume) ? description.options
            .volume : 1;
        ...
        else if (description.source === 'buffer')
            (initializeWithBuffer.bind(this))(description.options.buffer, callback);


        function getDescriptionError(description) {
            var supportedSources = ['wave', 'file', 'input', 'script', 'sound', 'buffer'];

            if (description && (!util.isFunction(description) && !util.isString(description) && !util
            ...
            if (util.isObject(description)) {
                ...
                if (description.source === 'file' && (!description.options || !description.options
                        .path))
                    return 'A path is needed for sounds with a file source';

                if (description.source === 'script' && (!description.options || !description.options
                        .audioFunction))
        ...
        function initializeWithUrl(paths, callback) {
            ...
            request.onload = function(progressEvent) {
                ...
                Pizzicato.context.decodeAudioData(progressEvent.target.response, (function(
                    buffer) {
                    ...
                    error = error || new Error('Error decoding audio file ' + paths[
                        0]);
        ...
        function initializeWithInput(options, callback) {
            ...
            if (!navigator.getUserMedia && (!navigator.mediaDevices || !!navigator.mediaDevices
                    .getUserMedia)) {
                console.error(
        ...
        function initializeWithBuffer(buffer, callback) {
            let audioBuffer = Array.isArray(buffer) ? buffer[0] : buffer;

            if (audioBuffer instanceof AudioBuffer) {
                this.getRawSourceNode = function() {
                    let context = Pizzicato.context.createBufferSource();
                    context.loop = this.loop;
                    context.buffer = audioBuffer;
                    return context;
                };
                if (typeof callback === "function") callback();
            } else {
                console.error("Invalid buffer provided. Expected an AudioBuffer.");
            }
        }
    };
    ...
    Pizzicato.Sound.prototype = Object.create(Pizzicato.Events, {
        ...
        pause: {
            ...
            value: function() {
                ...
                if (this.sourceNode.buffer)
                    this.offsetTime = elapsedTime % (this.sourceNode.buffer.length / Pz
                        .context.sampleRate);
                else
        ...
        addEffect: {
            ...
            value: function(effect) {
                ...
                var previousNode = this.effectConnectors.length > 0 ? this.effectConnectors[
                    this.effectConnectors.length - 1] : this.fadeNode;
        ...
        removeEffect: {
            ...
            value: function(effect) {
                ...
                var previousNode = (index === 0) ? this.fadeNode : this.effectConnectors[
                    index - 1];
                previousNode.disconnect();
        ...
        connectEffects: {
            ...
            value: function() {
                ...
                for (var i = 0; i < this.effects.length; i++) {
                    ...
                    var destinationNode = isLastEffect ? this.masterVolume : this.effects[i +
                        1].inputNode;
        ...
        getSourceNode: {
            ...
            value: function() {
                if (!!this.sourceNode) {
                    ...
                    previousSourceNode.gainSuccessor.gain.setValueAtTime(previousSourceNode
                        .gainSuccessor.gain.value, Pz.context.currentTime);
                    previousSourceNode.gainSuccessor.gain.linearRampToValueAtTime(0.0001, Pz
        ...
        applyAttack: {
            ...
            value: function() {
                ...
                this.fadeNode.gain.setTargetAtTime(1.0, Pz.context.currentTime,
        ...
        stopWithRelease: {
            ...
            value: function(callback) {
                ...
                var stopSound = function() {
                    return Pz.Util.isFunction(node.stop) ? node.stop(0) : node
                        .disconnect();
                };
                ...
                this.fadeNode.gain.setTargetAtTime(0.00001, Pz.context.currentTime,
    ...
    Pizzicato.Group.prototype = Object.create(Pz.Events, {
        ...
        addEffect: {
            ...
            value: function(effect) {
                ...
                // Connects effect in the last position
                var previousNode = this.effectConnectors.length > 0 ? this.effectConnectors[
                    this.effectConnectors.length - 1] : this.mergeGainNode;
                previousNode.disconnect();
                previousNode.connect(effect);
        ...
        removeEffect: {
            ...
            value: function(effect) {
                ...
                var previousNode = (index === 0) ? this.mergeGainNode : this.effectConnectors[
                    index - 1];
                previousNode.disconnect();
    ...
    Pizzicato.Effects.Distortion.prototype = Object.create(baseEffect, {
        ...
        adjustGain: {
            ...
            enumerable: false,
            value: function() {
                var gain = Pz.Util.isNumber(this.options.gain) ? parseInt(this.options.gain *
                    100, 10) : 50;
                var n_samples = 44100;
        ...
        _updatePosition: {
            value: function() {
                if (this.pannerNode && typeof this.pannerNode.setPosition === 'function') {
                    this.pannerNode.setPosition(this.options.x, this.options.y, this.options
                        .z);
                }
            }
        }
    ...
    Pizzicato.Effects.StereoPanner.prototype = Object.create(baseEffect, {
        ...
        pan: {
            ...
            set: function(pan) {
                ...
                var isStereoPannerNode = this.pannerNode.toString().indexOf(
                    'StereoPannerNode') > -1;
    ...
    Pizzicato.Effects.Convolver = function(options, callback) {
        ...
        request.onreadystatechange = function(event) {
            if (request.readyState === 4 && request.status !== 200) {
                console.error('Error while fetching ' + options.impulse + '. ' + request
                    .statusText);
            }
        };
        ...
        cutoff_frequency_low: {
            ...
            set: function(value) {
                if (Pizzicato.Util.isInRange(value, 10, 22050)) {
                    ...
                    this.midFilterNode.frequency.value = 0.707 * (this.options
                        .cutoff_frequency_low + this.options.cutoff_frequency_high);
                }
            }
        },
        ...
        frequencyData: {
            ...
            get: function() {
                if (this.byteFrequencyData === undefined)
                    this.byteFrequencyData = new Uint8Array(this.analyserNode
                        .frequencyBinCount.value);
    ...
    DiodeNode.prototype.setCurve = function() {
        ...
        for (i = _i = 0, _ref = wsCurve.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++
            _i : --_i) {
            ...
            if (v <= this.vb) {
                ...
                value = this.h * v - this.h * this.vl + (this.h * ((Math.pow(this.vl - this.vb, 2)) /
                    (2 * this.vl - 2 * this.vb)));
            }
            wsCurve[i] = value;
        }
    ...
    Pizzicato.Effects.RingModulator.prototype = Object.create(baseEffect, {
        ...
        distortion: {
            ...
            set: function(distortion) {
                ...
                var diodeNodes = [this.vInDiode1, this.vInDiode2, this.vcDiode3, this
                    .vcDiode4
                ];
    ...
    Pizzicato.Effects.Quadrafuzz.prototype = Object.create(baseEffect, {
        ...
        lowGain: {
            ...
            set: function(lowGain) {
                ...
                this.overdrives[0].curve = getDistortionCurve(Pz.Util.normalize(this.lowGain,
                    0, 150));
            }
        },
        ...
        midLowGain: {
            ...
            set: function(midLowGain) {
                ...
                this.overdrives[1].curve = getDistortionCurve(Pz.Util.normalize(this
                    .midLowGain, 0, 150));
            }
        },
        ...
        midHighGain: {
            ...
            set: function(midHighGain) {
                ...
                this.overdrives[2].curve = getDistortionCurve(Pz.Util.normalize(this
                    .midHighGain, 0, 150));
            }
        },
        ...
        highGain: {
            ...
            set: function(highGain) {
                ...
                this.overdrives[3].curve = getDistortionCurve(Pz.Util.normalize(this.highGain,
                    0, 150));
            }
        }
    });
